---
name: glm-ocr-agent
description: Use when integrating GLM-OCR SDK into agents, services, or tools, including MaaS/self-hosted mode selection, environment-variable configuration, and `parse()` result handling.
metadata:
  short-description: Integrate GLM-OCR SDK with agents
---

# GLM-OCR Agent Integration

This local skill is packaged from `upstream/glm-ocr/agent.md`.

Use it when the user asks to:
- Integrate GLM-OCR in code, scripts, or MCP tools
- Configure MaaS vs self-hosted mode
- Set environment variables for SDK behavior
- Serialize OCR output as JSON/Markdown
