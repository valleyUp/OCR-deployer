	...
	if (!file) {
		return (
			<div className='flex h-full items-center justify-center bg-background'>
				<div className='max-w-xs rounded-lg border border-dashed border-border bg-card/70 px-8 py-10 text-center text-sm text-muted-foreground'>
					<p className='text-[16px] font-medium text-foreground/80'
